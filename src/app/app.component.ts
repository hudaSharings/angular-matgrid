...
const ELEMENT_DATA: PeriodicElement[] = [
  { position: 1, name: "Hydrogen", weight: 1.0079, symbol: "H" ,date: new Date(), isActive:false},
  ...
  { position: 9, name: "Fluorine", weight: 18.9984, symbol: "F",date: new Date(),isActive:false },
  ...
  { position: 14, name: "Beryllium", weight: 9.0122, symbol: "Be",date: new Date(),isActive:false },
  ...
  { position: 22, name: "Helium", weight: 4.0026, symbol: "He",date: new Date() ,isActive:false},
  ...
  { position: 28, name: "Oxygen", weight: 15.9994, symbol: "O" ,date: new Date(),isActive:false},
